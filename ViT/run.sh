...
nohup mpirun -n 8 --bind-to core --map-by socket:PE=6 --rank-by core --report-bindings --allow-run-as-root \
python -u train_distill.py --name L2B_naive_distill_scratch --dataset imagenet1K --data_path /workspace/imagenet \
--model_type ViT-B_16 --num_steps 120000 --eval_every 1000 --train_batch_size 64 \
--gradient_accumulation_steps 2 --img_size 224 --learning_rate 0.06 --autocast \
--teacher_model_type ViT-L_16 --teacher_pretrained_dir output/ViT-L_16_checkpoint.pth \
--log_path logs/L2B_naive_distill_scratch > running_logs/L2B_naive_distill_scratch.txt 2>&1 &

wait $!

nohup mpirun -n 8 --bind-to core --map-by socket:PE=6 --rank-by core --report-bindings --allow-run-as-root \
python -u train_distill.py --name L2B_maskedkd_98_scratch --dataset imagenet1K --data_path /workspace/imagenet \
--model_type ViT-B_16 --num_steps 120000 --eval_every 1000 --train_batch_size 64 \
--gradient_accumulation_steps 2 --img_size 224 --learning_rate 0.06 --autocast \
--teacher_model_type ViT-L_16 --teacher_pretrained_dir output/ViT-L_16_checkpoint.pth \
--maskedkd --len_num_keep 98 \
--log_path logs/L2B_maskedkd_98_scratch > running_logs/L2B_maskedkd_98_scratch.txt 2>&1 &

wait $!

nohup mpirun -n 8 --bind-to core --map-by socket:PE=6 --rank-by core --report-bindings --allow-run-as-root \
python -u train_distill.py --name L2B_maskedkd_147_scratch --dataset imagenet1K --data_path /workspace/imagenet \
--model_type ViT-B_16 --num_steps 120000 --eval_every 1000 --train_batch_size 64 \
--gradient_accumulation_steps 2 --img_size 224 --learning_rate 0.06 --autocast \
--teacher_model_type ViT-L_16 --teacher_pretrained_dir output/ViT-L_16_checkpoint.pth \
--maskedkd --len_num_keep 147 \
--log_path logs/L2B_maskedkd_147_scratch > running_logs/L2B_maskedkd_147_scratch.txt 2>&1 &
