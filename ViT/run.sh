...
--log_path log_maskedkd_49 > running_log_maskedkd_49.txt 2>&1 &
...
--log_path log_maskedkd_147 > running_log_maskedkd_49.txt 2>&1 &
...
--log_path log_maskedkd_98 > running_log_maskedkd_49.txt 2>&1 &
...
--gradient_accumulation_steps 2 --img_size 224 --learning_rate 0.06 --autocast \
--teacher_model_type ViT-L_16 --teacher_pretrained_dir pretrained_models/ViT-L_16-224.npz \
--log_path log_naive > running_log_naive.txt 2>&1 &
