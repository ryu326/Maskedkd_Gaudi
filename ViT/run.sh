...
--maskedkd --len_num_keep 98 \
--log_path logs/B2S_maskedkd_98_scratch_2 > running_logs/B2S_maskedkd_98_scratch_2.txt 2>&1 &
...
--gradient_accumulation_steps 2 --img_size 224 --learning_rate 5e-4 --autocast \
--teacher_model_type ViT-B_16 --teacher_pretrained_dir output/L2B_maskedkd_98_ft_checkpoint.pth \
--log_path logs/B2S_naive_distill_scratch_2 > running_logs/B2S_naive_distill_scratch_2.txt 2>&1 &
...
--model_type ViT-S_16 --num_steps 100000 --eval_every 1000 --train_batch_size 512 \
--gradient_accumulation_steps 2 --img_size 224 --learning_rate 5e-4 --autocast \
--log_path logs/VIT-S_16_scratch_2 > running_logs/S_16_scratch_2.txt 2>&1 &
...
--teacher_model_type ViT-B_16 --teacher_pretrained_dir output/L2B_maskedkd_98_ft_checkpoint.pth \
--maskedkd --len_num_keep 147 \
--log_path logs/B2S_maskedkd_147_scratch_2 > running_logs/B2S_maskedkd_147_scratch_2.txt 2>&1 &
...
--teacher_model_type ViT-L_16 --teacher_pretrained_dir output/ViT-L_16_checkpoint.pth \
--maskedkd --len_num_keep 98 \
--log_path logs/L2S_maskedkd_98_scratch_2 > running_logs/L2S_maskedkd_98_scratch_2.txt 2>&1 &
...
--gradient_accumulation_steps 2 --img_size 224 --learning_rate 5e-4 --autocast \
--teacher_model_type ViT-L_16 --teacher_pretrained_dir output/ViT-L_16_checkpoint.pth \
--log_path logs/L2S_naive_distill_scratch_2 > running_logs/L2S_naive_distill_scratch_2.txt 2>&1 &
...
--teacher_model_type ViT-L_16 --teacher_pretrained_dir output/ViT-L_16_checkpoint.pth \
--maskedkd --len_num_keep 147 \
--log_path logs/L2S_maskedkd_147_scratch_2 > running_logs/L2S_maskedkd_147_scratch_2.txt 2>&1 &
