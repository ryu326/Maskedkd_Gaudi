...
--teacher_model_type ViT-L_16 --teacher_pretrained_dir output/ViT-L_16_checkpoint.pth \
--maskedkd --len_num_keep 98 \
--log_path logs/L2S_maskedkd_98_scratch > running_logs/L2S_maskedkd_98_scratch.txt 2>&1 &
...
--teacher_model_type ViT-L_16 --teacher_pretrained_dir output/ViT-L_16_checkpoint.pth \
--maskedkd --len_num_keep 147 \
--log_path logs/L2S_maskedkd_147_scratch > running_logs/L2S_maskedkd_147_scratch.txt 2>&1 &
